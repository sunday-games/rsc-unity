...
public class PopupAdvisor : Popup
{
    ...
    public override void Init()
    {
        ...
        if (platform == Platform.AppStore) askButtonsPositionKeyboard = askButtonsPositionKeyboardIOS;
        else if (platform == Platform.GooglePlay) askButtonsPositionKeyboard = askButtonsPositionKeyboardAndroid;
