...
public class EditorCoroutine
{
    ...
    class YieldDefault : ICoroutineYield
    {
    ...
    class YieldWaitForSeconds : ICoroutineYield
    {
    ...
    class YieldWWW : ICoroutineYield
    {
        public WWW Www;
        public override bool IsDone(float deltaTime)
        {
    ...
    class YieldAsync : ICoroutineYield
    {
    ...
    void GoStartCoroutine(Coroutine coroutine)
    {
    ...
    static void Test()
    {
        Type obj = typeof(UnityEngine.Coroutine);
