...
public class User : SG.User
{
    ...
    public void UpdateCoins(int change, bool syncServer)
    {
        ...
        coins += change;
        Log("Player" + (change > 0 ? " earn " + change : " spend " + -change) + " coins");
    ...
    public void GetBonusBox()
    {
        ...
        for (int i = 0; i < lastGetBoosts.Length; ++i)
        {
            ...
            Log("Player get " + lastGetBoosts[i].name);
        }
    ...
    public void UpdateRecord(long newRecord)
    {
        ...
        if (permanentRecord < newRecord)
        {
            ...
            Log("New Permanent Record: {0}", permanentRecord);
            syncServer = true;
        }
    ...
    public void GetSimpleCatbox()
    {
        ...
        Log("Open " + openCatbox + "th Simple Catbox");
    ...
    public void UpdateSpins(int change, bool syncServer)
    {
        ...
        spins += change;
        Log("Player" + (change > 0 ? " earn " + change : " spend " + -change) + " sausage");
