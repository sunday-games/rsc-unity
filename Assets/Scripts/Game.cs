...
public class Game : Core
{
    ...
    void Awake()
    {
        Log("Game Init - Version {0}.{1}", build.version, build.versionCode);
        ...
        server = GetComponentInChildren<SG.Server>();
        analytic = GetComponentInChildren<Analytic>();
        ads = GetComponentInChildren<SG.Ads>();
        ...
        //if (platform != Platform.AppStore) ObscuredPrefs.lockToDevice = ObscuredPrefs.DeviceLockLevel.Soft;
    ...
    //        if (!isFacebookInit)
    //        {
    //            Log("Loading - Facebook Init failed - Loading Stop");
    //            callbackLogin();
    //            return;
    //        }
    ...
    //        {
    //            Log("Loading - There no Facebook login previously - Loading Stop");
    //            callbackLogin();
    //            return;
    //        }

    //#if FACEBOOK
    //        Log("Loading - There Facebook login previously - Facebook Login...");
    ...
    //        {
    //            Log("Loading - Facebook Login failed - Loading Stop");
    //            callbackLogin();
    //            return;
    //        }
    ...
    //        Log("Loading - Facebook Login Success - Parse Login...");
    ...
    //        if (!isParseLogin)
    //        {
    //            Log("Loading - Parse Login failed - Loading Stop");
    //            callbackLogin();
    //            return;
    //        }

    //        Log("Loading - Parse Login Success - Merge local and parse data...");
    //#if PARSE
