...
using static ME.ECS.Mathematics.math;
...
namespace ME.ECS.Mathematics
{
    ...
    public partial struct quaternion : System.IEquatable<quaternion>, IFormattable
    {
        ...
        public quaternion inverse => math.inverse(this);
        ...
        /// <summary>Returns the result of a componentwise multiplication operation on a sfloat value and a float3 vector.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion operator *(quaternion lhs, quaternion rhs) { return mul(lhs, rhs); }
        ...
        public static quaternion RotateTowards(
            ...
            return num < sfloat.Epsilon ? to : math.slerpclamped(from, to, math.min(1f, maxDegreesDelta / num));
        }
        ...
        /// Euler rotation constructors such as EulerZXY(...).
        /// </summary>
        /// <param name="x">The rotation angle around the x-axis in degrees.</param>
        /// <param name="y">The rotation angle around the y-axis in degrees.</param>
        /// <param name="z">The rotation angle around the z-axis in degrees.</param>
        /// <param name="order">The order in which the rotations are applied.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerDeg(sfloat x, sfloat y, sfloat z, RotationOrder order = RotationOrder.Default)
        {
            return Euler(float3(x, y, z) * sfloat.deg2Rad, order);
        }
        ...
        /// Euler rotation constructors such as EulerZXY(...).
        /// </summary>
        /// <param name="xyz">The rotation angle in degrees.</param>
        /// <param name="order">The order in which the rotations are applied.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerDeg(float3 xyz, RotationOrder order = RotationOrder.Default)
        {
            return Euler(xyz * sfloat.deg2Rad, order);
        }
        ...
        {
            var t = 0.001;
            return math.all(new bool4(abs(lhs.value.x - rhs.value.x) < t, abs(lhs.value.y - rhs.value.y) < t,
                abs(lhs.value.z - rhs.value.z) < t,
                abs(lhs.value.w - rhs.value.w) < t)); //.IsEqualUsingDot(math.dot(lhs, rhs));
        }
    ...
    public static partial class math
    {
       ...
       /// <summary>Returns the inverse of a quaternion value.</summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion slerpclamped(quaternion q1, quaternion q2, sfloat t)
        {
            var clampedT = clamp(t, 0, 1);
            return slerp(q1, q2, clampedT);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsEqualUsingDot(sfloat dot) => dot > 0.9999989867210388;
