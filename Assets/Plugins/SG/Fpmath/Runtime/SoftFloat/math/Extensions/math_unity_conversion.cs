...
namespace ME.ECS.Mathematics
{
    ...
    public partial struct float3
    {
        public static explicit operator Vector3Int(float3 v)     { return new Vector3Int((int)v.x, (int)v.y, (int)v.z); }
        public static implicit operator float3(Vector3Int v)     { return new float3((sfloat)v.x, (sfloat)v.y, (sfloat)v.z); }
    }
